...
macro(test_targets)
  ...
  elseif(NOT APPLE) # Supported archs for Apple platforms are generated later
    ...
    elseif("${COMPILER_RT_DEFAULT_TARGET_ARCH}" MATCHES "mipsel|mips64el")
      ...
      test_target_arch(mipsel "" "-mabi=n32")
      test_target_arch(mips64el "" "-mabi=n64")
    elseif("${COMPILER_RT_DEFAULT_TARGET_ARCH}" MATCHES "mips|mips64")
      test_target_arch(mips "" "-mabi=n32")
      test_target_arch(mips64 "" "-mabi=n64")
    ...
    elseif("${COMPILER_RT_DEFAULT_TARGET_ARCH}" MATCHES "wasm32")
      test_target_arch(wasm32 "" "--target=wasm32-unknown-wasi")
    elseif("${COMPILER_RT_DEFAULT_TARGET_ARCH}" MATCHES "wasm64")
      test_target_arch(wasm64 "" "--target=wasm64-unknown-wasi")
